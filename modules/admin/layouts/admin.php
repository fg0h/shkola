...
<header id="header" style="background: white">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            Yii::$app->user->isGuest ? (''): (Yii::$app->user->identity->isAdmin()?(['label'=>'Кабинет админа', 'url'=>['/admin/']]):
                (['label'=>'Главная', 'url' => ['/site/index'], 'visible'=>Yii::$app->user->isGuest])),
            Yii::$app->user->isGuest
                ? ['label' => 'Авторизоваться', 'url' => ['/site/login'], 'visible'=>Yii::$app->user->isGuest]
                : '<li class="nav-item">'
...
<footer id="footer" style="z-index: 99" class="mt-auto py-3">
    <div class="container">
