...
<div class="groups-index">
    ...
    <div class="page-header">
        ...
        <div class="page-actions">
            <?= Html::a('<i class="fas fa-plus"></i> Создать группу', ['create'], ['class' => 'btn btn-create']) ?>
        </div>
    </div>
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($model) {
                        // Здесь можно добавить логику подсчета студентов
                ...
                [
                    ...
                    'label' => 'Преподаватель',
                    'value' => function($model) {
                        return $model->teacher->name ?? 'Не назначен';
                    }
                ],
                [
