...
<div class="raspisanie-index">
    ...
    <div class="page-header">
        <h1 class="page-title">
            <i class="fas fa-calendar-alt"></i> <?= Html::encode($this->title) ?>
        </h1>
        <div class="page-actions">
            <?= Html::a('<i class="fas fa-plus"></i> Добавить занятие', ['create'], ['class' => 'btn btn-create']) ?>
        </div>
    </div>
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($model) {
                        return $model->group->name ?? 'Не указана';
                    },
                ],
                [
                    'attribute' => 'user_id',
                    'label' => 'Пользователь',
                    'value' => function($model) {
                        return $model->user->username ?? 'Не указан';
                    },
                ],
                [
                    ...
                    'buttons' => [
                        ...
                        'delete' => function ($url) {
                            return Html::a('<i class="fas fa-trash"></i>', $url, [
                                ...
                                'data' => [
                                    'confirm' => 'Вы уверены, что хотите удалить это занятие?',
                                    'method' => 'post',
                                ],
                            ]);
                        },
